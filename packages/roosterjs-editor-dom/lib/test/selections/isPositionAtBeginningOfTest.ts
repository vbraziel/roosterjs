...
describe('isPositionAtBeginningOf()', () => {
    ...
    it('Has space before position', () => {
        ...
        runTest('<div id=id1>&#8203;<span></span>test</div>', () => $('id1'), 1, () => $('id1'), true);
        runTest('<div id=id1>&nbsp;<span></span>test</div>', () => $('id1'), 1, () => $('id1'), false);
    })
    ...
    it('Nested node', () => {
        runTest('<div id=id1><div id=id2>test</div></div>', () => $('id2'), 0, () => $('id1'), true);
        runTest('<div id=id1><div><div id=id2>test</div></div></div>', () => $('id2'), 0, () => $('id1'), true);
    })

    it('Has visible nodes before 1', () => {
        runTest('<div id=id1><img><div id=id2>test</div></div>', () => $('id2'), 0, () => $('id1'), false);
    })

    it('Has visible nodes before 2', () => {
        runTest('<div id=id1><div>test2</div><div id=id2>test</div></div>', () => $('id2'), 0, () => $('id1'), false);
    })

    it('Has visible nodes before 3', () => {
        runTest('<div id=id1><div><div>test2</div></div><div id=id2>test</div></div>', () => $('id2'), 0, () => $('id1'), false);
    })

    it('Position just before node', () => {
        runTest('<div id=id1>test<div id=id2>test</div></div>', () => $('id1'), 1, () => $('id2'), true);
    })
});
